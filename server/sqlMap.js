...
var sqlMap = {
  stu: {
    ...
    add:
      "insert into students (idstudents, name, gender,college) values (?,?,?,?)",
    ...
    checking:
      "select idstudents,name,gender,college,xingchengma,jiankangma,hesuan from students",
    baobei:
      "insert into baobei_term (idstudents, begin_place, end_place, description, reason) values (?,?,?,?,?)",
    cross_campus:
      "insert into cross_campus (idstudents,right_cross) values(?,1)"
  },
  fever: {
    check:
